...
do
    ...
    if [[ $Source == "TCWC" ]] #tests you're working with stuff from the correct museum
    then
        Museum="Tcwc" #sets museum with correct cases for next script
        Collection="F" #sets to F for fish collection
        echo $Museum #reads them out
        echo $Collection
    else
        echo "Not TCWC" # tells you if wrong museum
    fi
